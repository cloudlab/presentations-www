...
<div id="impress">
	...
	<div class="step" data-x="<?php echo $head+=800;?>" data-y="0" data-z="0" data-rotate="0" data-scale="1.0" style="line-height:36px;font-size:24px;">
		...
		<div style="float:left;color:#ccc;">
			...
			<b style="color:#fff">Workshop #2, Objects and Behaviors</b><br>
	...
	<div class="step"  data-x="<?php echo $head+=800;?>" data-y="0" style="line-height:36px;font-size:24px;">
		...
		<b>Next Class: Workshop (Relationships) &amp; Group Meetings</b>
		</span>
		<br>
		<b>For Next Week</b>		
		<li>Bring Charged Laptop for Workshop</li>
		<li>Signed up for a Group Meeting (before or after class)</li>
		<li>Bring Illustrated Object Narrative</li>
	</div>
