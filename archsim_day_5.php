...
<div class="step" data-x="<?php echo $x+=1000;?>" data-y="0" style="line-height:30px;font-size:20px;">
	...
	<div class="step" data-x="<?php echo $x+=1000;?>" data-y="0" style="line-height:36px;font-size:24px;">
		<?php makeGenericSlideWithHeight("","Meta-heuristics", "images/archsim/sample.jpg", "438"); ?>
	</div>
...
<!-- TOPILOGICAL OPTIMIZATION -->
	...
	<!-- Kangaroo Video -->
	<div class="step" data-x="<?php echo $x+=1000;?>" data-y="0" style="line-height:36px;font-size:24px;">
		<?php makeVideoSlide("","Topological Optimization (grasshopper + Millipede)","igRFFMSfwSQ"); ?> <!-- alt: 8706003 -->
	</div>
...
https://www.youtube.com/watch?v=CtYRfMzmWFU
	...
	DMST Topology Optimization (Introduction) Part 1 (step by step process)<br>
	https://www.youtube.com/watch?v=_erS8dRxILM<br>
	
	DOE CSGF 2011: On optimization of shape and topology (SOM and U of Illinois)<br>
	https://www.youtube.com/watch?v=yZxOVcpDMu4<br>
	
	Level Set Method<br>
	https://www.youtube.com/watch?v=bvf6Dm_HF4A<br>
	
	Mathematical Models for Engineers<br>
	https://www.youtube.com/watch?v=ZpOJJk6en2o<br>
...
<h1>Software</h1>	
ANSYS<br>
SolidThinking Inspire<br>
Altair OptiStruct, Hyperworks<br>
Topostruct, sawapan.eu<br>
</div>
...
<!-- PAPER TRAIL -->
	...
	<div class="step" data-x="<?php echo $x+=1000;?>" data-y="0" style="line-height:36px;font-size:24px;">
		<?php
		$images_a = array(
					'images/archsim/sample.jpg',
					'images/archsim/sample.jpg',
					'images/archsim/sample.jpg');
		makeImageGrid("", "", $images_a, 3); ?>
	</div>
	
	<div class="step" data-x="<?php echo $x+=1000;?>" data-y="0" style="line-height:36px;font-size:24px;">
		<?php makeGenericSlideWithHeight("","", "images/archsim/sample.jpg", "438"); ?>
	</div>
